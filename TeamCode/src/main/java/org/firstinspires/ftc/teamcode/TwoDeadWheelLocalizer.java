...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1867.1907130046313; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -750.514783820048; // x position of the perpendicular encoder (in tick units)
    }
